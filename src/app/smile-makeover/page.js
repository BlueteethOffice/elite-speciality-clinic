    ...
    <main style={{ padding: '100px 0', minHeight: '80vh', backgroundColor: 'white' }}>
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <h1 style={{ color: 'var(--primary-color)', fontSize: '2.5rem', marginBottom: '15px' }}>Smile Makeover</h1>
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', maxWidth: '800px', margin: '0 auto' }}>
            A comprehensive approach to improving the aesthetics of your smile through cosmetic dentistry.
          </p>
        </div>
